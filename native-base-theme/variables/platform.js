...
export default {
  ...
  tabActiveBgColor: (platform === 'ios') ? '#cde1f9' : 'white',
  ...
  get statusBarColor() {
    return color(this.toolbarDefaultBg).darken(0.2).hex(); //hexString()
  },
  ...
  get radioSelectedColor() {
    return color(this.radioColor).darken(0.2).hex(); //hexString()
  },
  ...
  get darkenHeader() {
    return color(this.tabBgColor).darken(0.03).hex(); //hexString()
  },
